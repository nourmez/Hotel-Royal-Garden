...
--
-- Client :  localhost
-- Généré le :  Mer 13 Juin 2018 à 15:32
...
--
-- Contraintes pour la table `agenceVoyage`
--
ALTER TABLE `agenceVoyage`
  ADD CONSTRAINT `agencevoyage_ibfk_1` FOREIGN KEY (`id_employe`) REFERENCES `employe` (`id_employe`);
